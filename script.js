...
const applyMap=(text,map,fallback='\u0332')=>[...text].map(ch=>map[ch]||((ch==='\n'||ch===' ') ? ch : ch+fallback)).join('');
...
const styles=[
 {id:'bold',name:'Жирный',cat:'simple',fn:t=>applyMap(t,maps.bold,'\u0332')},
 {id:'italic',name:'Курсивный',cat:'simple',fn:t=>applyMap(t,maps.italic,'\u0301')},
 {id:'boldItalic',name:'Жирный курсивный',cat:'simple',fn:t=>applyMap(t,maps.boldItalic,'\u0336')},
 {id:'mono',name:'Моноширинный',cat:'simple',fn:t=>applyMap(t,maps.mono,'\u0305')},
 {id:'double',name:'Двойной контур',cat:'decorative',fn:t=>applyMap(t,maps.double,'\u20DE')},
 {id:'gothic',name:'Готический',cat:'decorative',fn:t=>applyMap(t,maps.gothic,'\u0338')},
 {id:'gothicBold',name:'Жирный готический',cat:'decorative',fn:t=>applyMap(t,maps.gothicBold,'\u0337')},
 ...
 {id:'fullwidth',name:'Широкий',cat:'symbols',fn:t=>[...t].map(c=>{const n=c.codePointAt(0); if(n>=0x21&&n<=0x7e)return String.fromCodePoint(n+0xfee0); return (c==='\n'||c===' ') ? c : c+'\u0304';}).join('')}
];
